...
namespace WinClient
{
    public partial class Form1 : Form
    {
        ...
        {
            var attribute = message.GetType().GetCustomAttribute<DataContractAttribute>();
            if (attribute == null)
            {
                throw new NotSupportedException("The message is not generated from a schema");
            }
            return string.Format("{0}#{1}", attribute.Namespace, attribute.Name);            
        }
